...
const people = [{ name: "Meet" }, { name: "Dhyan" }, { name: "Mann"}, { name: "Ankit"}, { name: "Ayush"}];
console.log(getNames(people));
 // Output: ["Meet", "Dhyan", "Mann", "Ankit", "Ayush"]


//Task 5
 const findLongestWord = arr => arr.reduce((a, b) => b.length > a.length ? b : a, "");
 console.log(findLongestWord(["sondarvameet", "pateldhyan", "solankimann", "solankiankit", "vadodariyaayush"]));
 //output: sondarvameet
